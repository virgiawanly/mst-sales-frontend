...
module.exports = plugin(function ({ addComponents, theme }) {
  addComponents({
    '.flatpickr-calendar': {
      '@apply text-sm bg-white dark:bg-zink-700 rounded-md dark:shadow-md dark:shadow-zink-500': {},
      width: '307.875px',
    ...
    '.flatpickr-months': {
      '@apply bg-transparent flex content-center items-center h-12': {},

      '.flatpickr-month': {
        '@apply text-slate-500 dark:text-zink-200 dark:fill-zink-500 fill-slate-600 h-12': {},

        '.flatpickr-current-month': {
          '@apply flex justify-center content-center items-center gap-x-2 text-15 h-auto pt-0 top-0 bottom-0': {},
      ...
      '.flatpickr-prev-month, .flatpickr-next-month': {
        '@apply mt-2 mx-2 text-slate-500 fill-slate-500 h-8 w-8 flex items-center hover:text-slate-600 dark:hover:text-zink-100 top-2 border border-slate-200 dark:border-zink-500 dark:text-zink-200 rounded-md':
          {},
    ...
    '.flatpickr-day': {
      ...
      '&.today': {
        '@apply !text-custom-500 !bg-transparent !border-custom-500': {},
        '&:hover, &:focus': {
          '@apply !text-white !bg-custom-600 !border-custom-600': {},
        },
      },
      ...
      '&.inRange, &.week.selected': {
        boxShadow: `-10px 0 0 ${theme('colors.slate.100')}, 10px 0 0 ${theme('colors.slate.100')}`,
    ...
    '[data-mode="dark"]': {
      '.flatpickr-day': {
        '&.inRange, &.week.selected': {
          boxShadow: `-10px 0 0 ${theme('colors.zink.500')}, 10px 0 0 ${theme('colors.zink.500')}`,
        },
      },
